...
location.href = "./Worldpay_HMRC_P2_OLD.php?refID="+refVal+"&Amount="+amt;

}
function sendCardType(value){

location.href = "./Worldpay_HMRC_P2_OLD.php?refID="+refVal+"&Amount="+amt+"&CardType="+value;
