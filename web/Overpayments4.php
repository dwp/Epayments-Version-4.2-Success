...
<link href="public/stylesheets/elements.css" rel="stylesheet" type="text/css">
  <script type="text/javascript"> 
    function completeAndRedirect(){
      location.href = "./Worldpay_HMRC_P1_OLD.html?refID="+document.getElementById('ni-number').value+"&Amount="+document.getElementById('amount-number').value;
    }
  </Script>
</head>
...
<input type="text" style="text-transform: uppercase" pattern="[0-9]+(\.[0-9]{1,2})?|\.[0-9]{2}" maxlength="8" oninvalid="setCustomValidity('Please enter a valid amount')" onchange="try{setCustomValidity('')}catch(e){}" name="amount-number" id="amount-number" class="text" value="" align="top">
    <nav class="form-steps" role="navigation">
        <ul>
            ...
            <li><a id="backButtonBottom" href="./Overpayment3.php">Back</a></li>
        </ul>
    </nav>
  </form>
