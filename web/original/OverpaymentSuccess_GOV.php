...
var win = window.open("./OverpaymentsReceipt.php?refID="+refVal+"&Amount="+amt,"_blank");
win.focus();
...
<main id="content" role="main" class="group">
 <br/>
  <div>
   ...
   <table border="0">
  <tr><td> <h2>&nbsp;&nbsp;&nbsp;Your Payment for <img src="./pound1.gif" alt="PoundSign" height ="17" align ="bottom"><script type="text/javascript">
document.write(amt);</script> has been processed successfully. </h2></td></tr>
    <tr><td> <h3>&nbsp;&nbsp;&nbsp; Transaction ID :43236WPGV</td></h3></tr>
	<tr><td> <h3>&nbsp;&nbsp;&nbsp; Transaction Date :<strong><span id="time"></span>
        </strong>  </td></h3></tr>
	<tr><td> <h3>&nbsp;&nbsp;&nbsp; Reference : <script type="text/javascript">
document.write(refVal);</script>
 </td> </h3></tr>
	<tr><td> <h3>&nbsp;&nbsp;&nbsp; If you have entered an email address on the payment screen you will receive a confirmation shortly.</td> </h3></tr>
	<tr><td> <h3>&nbsp;&nbsp;&nbsp; Please print this for your future reference. </td></h3></tr>
</table>
  </div>
  <br/>
 ...
 <tr> <td></td>
  ...
  <div>
	  ...
	  <form action="./Overpayments_welcome.htm" method="post" autocomplete="off" novalidate="novalidate">
        <td  class="get-started group"><input type="submit" name="return" id="return" value="Return to GOV.UK"   class="button" /></td>
		  <td>&nbsp; &nbsp;&nbsp;&nbsp;</td>
		 <td  class="get-started group"> <a href="#" onClick="javascript:completeAndRedirect();"><input type="button" name="print"  class="button" onClick="./Overpayments_welcome.htm" value="Print Receipt"  /></a></td>
       </form>
      </table>
	  </div>
