...
.containercell tr + input + tr + tr td table tr {
...
.containercell tr + input + tr + tr td table tr + tr img {
  float: left;
  margin: 7px 15px;
  display: none;
}

.containercell tr + input + tr + tr td table tr td {
  float: left;
}

.containercell tr + input + tr + tr td table tr td:first-child {
  min-width:160px;
}
                ...
                <tr>
                    <td class="two" width="100%">
                        <table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td colspan="2" class="two"><nobr>&nbsp;<span style=" font-family: Verdana,Geneva,Arial,Helvetica,Sans-Serif; font-size: 8pt; color: #002469;"><em>All fields are mandatory</em></span></nobr></td>
                            </tr>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td class="two">
                        <table cellpadding="0" cellspacing="0" border="0">
                            <tr valign=top>
                                <td colspan="2" class="two"><span style=" font-family: Verdana,Geneva,Arial,Helvetica,Sans-Serif; font-size: 8pt; color: #002469;"><em>All fields are mandatory</em></span></td>
                            </tr>
